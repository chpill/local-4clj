...
;; A ;; http://en.wikipedia.org/wiki/Deterministic_finite_automaton;;  is an abstract machine that recognizes a ;;  http://en.wikipedia.org/wiki/Regular_language;; . Usually a DFA is defined by a 5-tuple, but instead we'll use a map with 5 keys:
